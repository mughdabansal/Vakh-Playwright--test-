  ...
  <div class="container">
    ...
    <div id="view-chat" class="view-content">
      <div class="panel">
        ...
        <h3 style="margin: 1rem 0 0.75rem; font-size: 1rem; color: #a78bfa; display: flex; align-items: center; gap: 0.5rem;">
          <span>🧪</span> Automated Chat Test Matrix (16 Tests Passed across 4 Browsers)
          <span style="font-size: 0.78rem; color: var(--text-dim); font-weight: normal; margin-left: auto;"><code>src/tests/chat.spec.ts</code></span>
        </h3>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td><strong>Chat Page UI Layout, Header & Active Stream</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Asserts Messages heading, New Message CTA, and conversation cards stream container.</span></td>
              <td><code>/messages &rarr; [role="menuitem"], New Message</code></td>
            ...
            <tr>
              ...
              <td><strong>1-on-1 Direct Messaging & Real-Time Delivery</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Initiates 1-on-1 DM with @happy_badger_2312, transmits unique timestamped text, verifies bubble rendering.</span></td>
              <td><code>textarea[placeholder*="Type a message"], Send message</code></td>
              <td><span class="badge passed">✅ 14.6s</span></td>
            ...
            <tr>
              ...
              <td><strong>Multi-Peer Group Chat Creation</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Searches & selects multiple allowed peers (@happy_badger_2312, @mughdabansal1414), triggers "Create Group".</span></td>
              <td><code>button[aria-label="Create Group"] &rarr; Thread</code></td>
            ...
            <tr>
              ...
              <td><strong>Group Chat Name Editing by Admin / Owner</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Opens Conversation Settings, clicks "Edit group name", updates group title and asserts real-time heading reflection.</span></td>
              <td><code>button[aria-label="Edit group name"] &rarr; Title</code></td>
            ...
            <tr>
              ...
              <td><strong>Adding Allowed Member to Existing Group Chat</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Opens group settings, clicks "Add members", searches for allowed contact and confirms roster expansion.</span></td>
              <td><code>button[aria-label="Add members"] &rarr; Search</code></td>
              <td><span class="badge passed">✅ 13.2s</span></td>
            ...
            <tr>
              ...
              <td><strong>Promoting Eligible Member to Group Admin Role</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Selects eligible member in roster, clicks "Make admin", asserts admin role assignment in settings.</span></td>
              <td><code>button[aria-label*="Make"][aria-label*="admin"]</code></td>
            ...
            <tr>
              ...
              <td><strong>Demoting Admin Back to Regular Member</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Selects admin user, executes "Remove admin", asserts privilege revocation back to regular member.</span></td>
              <td><code>button[aria-label*="Remove admin"]</code></td>
              <td><span class="badge passed">✅ 12.6s</span></td>
              <td><span class="badge passed">✅ 14.8s</span></td>
              <td><span class="badge passed">✅ 16.5s</span></td>
              <td><span class="badge passed">✅ 13.2s</span></td>
            ...
            <tr>
              ...
              <td><strong>Removing Member from Group Chat</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Group admin clicks "Remove [user]" to evict regular member from conversation.</span></td>
              <td><code>button[aria-label*="Remove"]</code></td>
            ...
            <tr>
              ...
              <td><strong>Photo / Image Attachment Upload</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Opens attachment drawer, triggers "Attach photos", and uploads sample PNG image binary.</span></td>
              <td><code>button[aria-label="Attach photos"] &rarr; FileChooser</code></td>
              <td><span class="badge passed">✅ 15.6s</span></td>
              <td><span class="badge passed">✅ 18.2s</span></td>
              <td><span class="badge passed">✅ 20.4s</span></td>
              <td><span class="badge passed">✅ 16.3s</span></td>
            ...
            <tr>
              ...
              <td><strong>Document File Attachment Upload</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Opens attachment drawer, triggers "Attach files", and uploads sample text document fixture.</span></td>
              <td><code>button[aria-label="Attach files"] &rarr; FileChooser</code></td>
              <td><span class="badge passed">✅ 17.1s</span></td>
            ...
            <tr>
              ...
              <td><strong>Cleanly Leaving Group Conversation</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Clicks "Leave conversation" in group settings, confirms exit and validates graceful navigation.</span></td>
              <td><code>button[aria-label="Leave conversation"]</code></td>
              <td><span class="badge passed">✅ 12.8s</span></td>
            ...
            <tr>
              ...
              <td><strong>[Negative] Empty & Whitespace Message Submission Block</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Enforces that typing whitespace or leaving input empty disables send CTA or blocks empty dispatch.</span></td>
              <td><code>textarea &rarr; button[disabled] / hidden</code></td>
            ...
            <tr>
              ...
              <td><strong>[Negative] Group Creator Protection from Admin Removal</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Validates CREATOR badge on @m_2094 and verifies other admins cannot remove or demote the owner.</span></td>
            ...
            <tr>
              ...
              <td><strong>[Negative] Regular Members Cannot Remove Admins</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Asserts non-admin members lack moderation actions over admins in the conversation roster.</span></td>
            ...
            <tr>
              ...
              <td><strong>[Negative] Admin Promotion Requires Accepted Membership</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Enforces that pending invitees cannot be elevated to admin status before joining the group.</span></td>
            ...
            <tr>
              ...
              <td><strong>[Edge] Rich Text, Emojis & Multi-Line Linebreaks</strong><br><span style="font-size: 0.78rem; color: var(--text-muted);">Transmits multi-line messages with emojis (🚀, 🧪) and symbols (@#$%^&*) without escaping errors.</span></td>
      ...
      <div class="panel">
        <div class="panel-header">
          <div class="panel-title">🧩 Chat Module Component & Interaction Specifications</div>
          <span style="font-size: 0.8rem; color: var(--text-muted);">Derived from src/pages/ChatPage.ts</span>
        </div>
