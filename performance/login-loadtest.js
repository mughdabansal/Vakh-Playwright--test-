...
const targetUrl = 'https://eve.vakh.com/auth/sign-in';
...
console.log(`Starting performance benchmark for ${targetUrl}...`);
...
const instance = autocannon({
  ...
  headers: {
    'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) PlaywrightPerfTest/1.0',
  ...
  const summaryMarkdown = `# ⚡ Performance Load Test Report: Eve Vakh Login Page
...
*Report saved to \`test-reports/performance-report.json\`*
`;

  const mdPath = path.join(outputDir, 'performance-summary.md');
